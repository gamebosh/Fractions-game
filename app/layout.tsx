...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "https://gamebosh-fraction-quest.souhailachahod5.chatgpt.site/gamebosh-banner.png", width: 1024, height: 500, alt: "GameBosh Fraction Quest" }],
  },
  twitter: { card: "summary_large_image", title: "GameBosh Fraction Quest", description: "Free fraction games for kids with 1,200+ challenges.", images: ["https://gamebosh-fraction-quest.souhailachahod5.chatgpt.site/gamebosh-banner.png"] },
